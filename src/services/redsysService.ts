...
// Configuración de Redsys (necesitarás actualizar estos valores)
const REDSYS_CONFIG = {
  merchantCode: 'TU_CODIGO_COMERCIO', // Código de comercio de Redsys
  terminal: '001', // Terminal (normalmente 001)
  secretKey: 'TU_CLAVE_SECRETA', // Clave secreta de Redsys
  url: 'https://sis-t.redsys.es:25443/sis/realizarPago', // URL de test (cambiar a producción)
  currency: '978', // EUR
